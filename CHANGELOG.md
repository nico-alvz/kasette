...
- The optional Cloudflare Pages deployment (`wrangler.jsonc`, the
  `deploy:cloudflare` script, and `docs/cloudflare-pages.md`). GitHub Pages
  is the project's only deployment target now.

### Changed

- Trimmed repeated "100% local, no accounts, no servers" phrasing in the
  README down to one place.
