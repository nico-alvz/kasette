...
Sonora is a fully client-side, offline application with no backend, no
...
[GitHub Security Advisories](https://github.com/nico-alvz/sonora/security/advisories/new)
